                ...
                <div class="p-5">
                  ...
                  <form action="" method="POST" class="user">
                    <div class="form-group">
                      <input name="txtUsuario" type="text" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Direccion de correo..." value ="">
                    </div>
                    <div class="form-group">
                      <input name="txtClave" type="password" class="form-control form-control-user" id="exampleInputPassword" placeholder="Contraseña" value ="">
                    </div>
                    <div class="form-group">
